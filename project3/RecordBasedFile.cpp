 ...
 * Modifier and Integrator: Benjy Strauss
...
RBFM_ScanIterator::getNextRecord(RID &rid, void *data) {
	if (currentPosition == rids.size()) { return RBFM_EOF; }
...
void
RBFM_ScanIterator::setVectors(vector<RID> rids, vector<int> dataVectorSizes, vector<void*> dataVector) {
	this->rids = rids;
...
void
RecordBasedFileManager::newRecordBasedPage(void * page) {
...
SlotDirectoryHeader
RecordBasedFileManager::getSlotDirectoryHeader(void * page) {
...
RecordBasedFileManager::getSlotDirectoryRecordEntry(void * page, unsigned recordEntryNumber) {
...
void
RecordBasedFileManager::setSlotDirectoryRecordEntry(void * page, unsigned recordEntryNumber, SlotDirectoryRecordEntry recordEntry) {
...
unsigned
RecordBasedFileManager::getPageFreeSpaceSize(void * page) {
...
unsigned
RecordBasedFileManager::getRecordSize(const vector<Attribute> &recordDescriptor, const void *data) {
	unsigned size = 0;
