...
int
RelationManager::getTableID(const string &tableName, int &tableID) {
	FileHandle fileHandle;
...
vector<Attribute>
RelationManager::getTablesRecordDescriptor() {
...
vector<Attribute>
RelationManager::getColumnsRecordDescriptor() {
...
void
RelationManager::prepareTablesRecordData(int id, string tableName, void * outputData) {
...
void
RelationManager::prepareColumnsRecordData(int tableID, Attribute attr, void * outputData) {
	int offset = 0;
...
RelationManager::insertTuple(const string &tableName, const void *data, RID &rid) {
	...
	// Insert the record.
	int result = _rbfm->insertRecord(fileHandle, recordDescriptor, data, rid);
...
RelationManager::deleteTuples(const string &tableName) {
	...
	// Delete the records.
	int result = _rbfm->deleteRecords(fileHandle);
...
RelationManager::deleteTuple(const string &tableName, const RID &rid) {
	...
	// Delete the record.
	int result = _rbfm->deleteRecord(fileHandle, recordDescriptor, rid);
...
RelationManager::updateTuple(const string &tableName, const void *data, const RID &rid) {
	...
	// Update the record.
	int result = _rbfm->updateRecord(fileHandle, recordDescriptor, data, rid);
...
RelationManager::readTuple(const string &tableName, const RID &rid, void *data) {
	...
	// Reads the record.
	int result = _rbfm->readRecord(fileHandle, recordDescriptor, rid, data);
...
RelationManager::readAttribute(const string &tableName, const RID &rid, const string &attributeName, void *data) {
	...
	// Reads the attribute.
	int result = _rbfm->readAttribute(fileHandle, recordDescriptor, rid, attributeName, data);
...
RelationManager::reorganizePage(const string &tableName, const unsigned pageNumber) {
	...
	int result = _rbfm->reorganizePage(fileHandle, recordDescriptor, pageNumber);
...
// Extra credit
int
RelationManager::dropAttribute(const string &tableName, const string &attributeName) {
    return -1;
}

// Extra credit
int
RelationManager::addAttribute(const string &tableName, const Attribute &attr) {
    return -1;
}

// Extra credit
int
RelationManager::reorganizeTable(const string &tableName) {
    return -1;
}
